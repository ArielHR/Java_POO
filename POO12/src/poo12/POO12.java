...
public class POO12 {
    ...
    public static void main(String[] args) {
        ...
        Persona P1 = Ps.creacionPersona();
        Scanner leer = new Scanner(System.in);
        
        System.out.println("Ingresa uns segunda edad");
        int edadExtra = leer.nextInt();
        if (Ps.menorQue(Ps.calcularEdad(P1), edadExtra)) {
            System.out.println(P1.getNombre() + " es mayor que la segunda edad");
        } else  {
            System.out.println("La segunda edad es mayor que " + P1.getNombre());
        }
