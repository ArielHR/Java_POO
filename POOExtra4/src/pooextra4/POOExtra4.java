/*
4. Dígito Verificador. Crear una clase NIF que se usará para mantener DNIs con su correspondiente letra (NIF).
...
La letra correspondiente al dígito verificador se calculará a traves de un método que funciona d
e la siguiente manera: Para calcular la letra se toma el resto de dividir el número de DNI por 23
...
public class POOExtra4 {
    ...
    public static void main(String[] args) {
       ...
       NIF nifU = Ns.crearNIF();
        System.out.println("");
        System.out.println(Ns.toString(nifU));
    }
